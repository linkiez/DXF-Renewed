...
## [9.0.1](https://github.com/linkiez/DXF-Renewed/compare/v9.0.0...v9.0.1) (2026-09-22)

## [9.0.0](https://github.com/linkiez/DXF-Renewed/compare/v8.0.0...v9.0.0) (2026-09-16)

## [8.0.0](https://github.com/linkiez/DXF-Renewed/compare/v7.7.6...v8.0.0) (2026-09-16)

## <small>7.7.6 (2026-09-11)</small>

* refactor(geometry): share quarter-turn vector calculation ([db00d9c](https://github.com/linkiez/DXF-Renewed/commit/db00d9c))
* refactor(nesting): reduce extraction complexity ([44dc098](https://github.com/linkiez/DXF-Renewed/commit/44dc098))
* fix(attdef): document DXF dispatch complexity ([f9ddde6](https://github.com/linkiez/DXF-Renewed/commit/f9ddde6))
...
* fix(build): restore release pipeline ([a630000](https://github.com/linkiez/DXF-Renewed/commit/a630000))
* fix(ci): refresh yarn lockfile ([55fc89a](https://github.com/linkiez/DXF-Renewed/commit/55fc89a))
* fix(ci): use stable action versions ([251c393](https://github.com/linkiez/DXF-Renewed/commit/251c393))
* chore(deps)(deps-dev): bump esbuild from 0.28.0 to 0.28.1 (#60) ([627df04](https://github.com/linkiez/DXF-Renewed/commit/627df04)), closes [#60](https://github.com/linkiez/DXF-Renewed/issues/60)
* chore(deps)(deps-dev): bump the development-dependencies group across 1 directory with 13 updates ([8b456e2](https://github.com/linkiez/DXF-Renewed/commit/8b456e2))
* chore(deps)(deps-dev): bump the development-dependencies group across 1 directory with 18 updates ([0836924](https://github.com/linkiez/DXF-Renewed/commit/0836924))
* chore(deps)(deps-dev): bump the development-dependencies group across 1 directory with 19 updates ([be492d2](https://github.com/linkiez/DXF-Renewed/commit/be492d2))
* chore(deps)(deps-dev): bump vite from 8.0.14 to 8.0.16 (#62) ([de7f68f](https://github.com/linkiez/DXF-Renewed/commit/de7f68f)), closes [#62](https://github.com/linkiez/DXF-Renewed/issues/62)
* chore(deps)(deps): bump @sigstore/core from 3.0.0 to 3.2.1 ([792d855](https://github.com/linkiez/DXF-Renewed/commit/792d855))
* chore(deps)(deps): bump brace-expansion from 1.1.12 to 1.1.18 (#80) ([4a26bf4](https://github.com/linkiez/DXF-Renewed/commit/4a26bf4)), closes [#80](https://github.com/linkiez/DXF-Renewed/issues/80)
* chore(deps)(deps): bump fast-uri from 3.1.0 to 3.1.2 ([bcc9c1e](https://github.com/linkiez/DXF-Renewed/commit/bcc9c1e))
* chore(deps)(deps): bump fast-uri from 3.1.2 to 3.1.5 (#82) ([dab1c34](https://github.com/linkiez/DXF-Renewed/commit/dab1c34)), closes [#82](https://github.com/linkiez/DXF-Renewed/issues/82)
* chore(deps)(deps): bump flatted from 3.3.3 to 3.4.2 ([c368079](https://github.com/linkiez/DXF-Renewed/commit/c368079))
* chore(deps)(deps): bump handlebars from 4.7.8 to 4.7.9 ([f2eac60](https://github.com/linkiez/DXF-Renewed/commit/f2eac60))
* chore(deps)(deps): bump ip-address from 10.1.0 to 10.2.0 ([98d7300](https://github.com/linkiez/DXF-Renewed/commit/98d7300))
* chore(deps)(deps): bump ip-address from 10.2.0 to 10.5.0 (#86) ([e9a18a8](https://github.com/linkiez/DXF-Renewed/commit/e9a18a8)), closes [#86](https://github.com/linkiez/DXF-Renewed/issues/86)
* chore(deps)(deps): bump js-yaml from 4.1.1 to 4.3.1 (#81) ([3cf5d32](https://github.com/linkiez/DXF-Renewed/commit/3cf5d32)), closes [#81](https://github.com/linkiez/DXF-Renewed/issues/81)
* chore(deps)(deps): bump lodash from 4.17.23 to 4.18.1 ([a1142e8](https://github.com/linkiez/DXF-Renewed/commit/a1142e8))
* chore(deps)(deps): bump lodash-es from 4.17.21 to 4.18.1 ([d5016b3](https://github.com/linkiez/DXF-Renewed/commit/d5016b3))
* chore(deps)(deps): bump minimatch from 3.1.2 to 3.1.5 ([d89ee51](https://github.com/linkiez/DXF-Renewed/commit/d89ee51))
* chore(deps)(deps): bump picomatch from 2.3.1 to 2.3.2 ([a95fa83](https://github.com/linkiez/DXF-Renewed/commit/a95fa83))
* chore(deps)(deps): bump postcss from 8.5.15 to 8.5.26 (#87) ([dc29f55](https://github.com/linkiez/DXF-Renewed/commit/dc29f55)), closes [#87](https://github.com/linkiez/DXF-Renewed/issues/87)
* chore(deps)(deps): bump qs from 6.15.0 to 6.15.2 ([212af7f](https://github.com/linkiez/DXF-Renewed/commit/212af7f))
* chore(deps)(deps): bump shell-quote from 1.8.3 to 1.10.0 (#76) ([ed9724b](https://github.com/linkiez/DXF-Renewed/commit/ed9724b)), closes [#76](https://github.com/linkiez/DXF-Renewed/issues/76)
* chore(deps)(deps): bump sigstore from 4.0.0 to 4.1.1 (#70) ([a4bc2a1](https://github.com/linkiez/DXF-Renewed/commit/a4bc2a1)), closes [#70](https://github.com/linkiez/DXF-Renewed/issues/70)
* chore(deps)(deps): bump tar from 7.5.11 to 7.5.22 (#77) ([d83375b](https://github.com/linkiez/DXF-Renewed/commit/d83375b)), closes [#77](https://github.com/linkiez/DXF-Renewed/issues/77)
* chore(deps)(deps): bump tar from 7.5.9 to 7.5.11 ([0e5e589](https://github.com/linkiez/DXF-Renewed/commit/0e5e589))
* chore(deps)(deps): bump the production-dependencies group across 1 directory with 2 updates (#56) ([c48ffda](https://github.com/linkiez/DXF-Renewed/commit/c48ffda)), closes [#56](https://github.com/linkiez/DXF-Renewed/issues/56)
* merge chore PR #44 ([d45643f](https://github.com/linkiez/DXF-Renewed/commit/d45643f)), closes [#44](https://github.com/linkiez/DXF-Renewed/issues/44)
* merge chore PR #63 ([82b0130](https://github.com/linkiez/DXF-Renewed/commit/82b0130)), closes [#63](https://github.com/linkiez/DXF-Renewed/issues/63)
* merge chore PR #71 ([24f0a21](https://github.com/linkiez/DXF-Renewed/commit/24f0a21)), closes [#71](https://github.com/linkiez/DXF-Renewed/issues/71)
* merge chore PR #73 ([7fff1b0](https://github.com/linkiez/DXF-Renewed/commit/7fff1b0)), closes [#73](https://github.com/linkiez/DXF-Renewed/issues/73)
* merge chore PR #85 ([635e6c5](https://github.com/linkiez/DXF-Renewed/commit/635e6c5)), closes [#85](https://github.com/linkiez/DXF-Renewed/issues/85)
* Merge pull request #33 from linkiez/dependabot/npm_and_yarn/minimatch-3.1.5 ([d73ec86](https://github.com/linkiez/DXF-Renewed/commit/d73ec86)), closes [#33](https://github.com/linkiez/DXF-Renewed/issues/33)
* Merge pull request #36 from linkiez/dependabot/npm_and_yarn/tar-7.5.11 ([960b721](https://github.com/linkiez/DXF-Renewed/commit/960b721)), closes [#36](https://github.com/linkiez/DXF-Renewed/issues/36)
* Merge pull request #37 from linkiez/dependabot/npm_and_yarn/development-dependencies-5fa01c43cb ([859ce7a](https://github.com/linkiez/DXF-Renewed/commit/859ce7a)), closes [#37](https://github.com/linkiez/DXF-Renewed/issues/37)
* Merge pull request #38 from linkiez/dependabot/npm_and_yarn/flatted-3.4.2 ([1f416d2](https://github.com/linkiez/DXF-Renewed/commit/1f416d2)), closes [#38](https://github.com/linkiez/DXF-Renewed/issues/38)
* Merge pull request #40 from linkiez/dependabot/npm_and_yarn/picomatch-2.3.2 ([25200bc](https://github.com/linkiez/DXF-Renewed/commit/25200bc)), closes [#40](https://github.com/linkiez/DXF-Renewed/issues/40)
* Merge pull request #41 from linkiez/dependabot/npm_and_yarn/handlebars-4.7.9 ([e43543b](https://github.com/linkiez/DXF-Renewed/commit/e43543b)), closes [#41](https://github.com/linkiez/DXF-Renewed/issues/41)
* Merge pull request #43 from linkiez/dependabot/npm_and_yarn/lodash-es-4.18.1 ([965f0c9](https://github.com/linkiez/DXF-Renewed/commit/965f0c9)), closes [#43](https://github.com/linkiez/DXF-Renewed/issues/43)
* Merge pull request #50 from linkiez/dependabot/npm_and_yarn/ip-address-10.2.0 ([f77a53c](https://github.com/linkiez/DXF-Renewed/commit/f77a53c)), closes [#50](https://github.com/linkiez/DXF-Renewed/issues/50)
* Merge pull request #51 from linkiez/dependabot/npm_and_yarn/fast-uri-3.1.2 ([ea02f85](https://github.com/linkiez/DXF-Renewed/commit/ea02f85)), closes [#51](https://github.com/linkiez/DXF-Renewed/issues/51)
* Merge pull request #54 from linkiez/dependabot/npm_and_yarn/qs-6.15.2 ([31eaeb5](https://github.com/linkiez/DXF-Renewed/commit/31eaeb5)), closes [#54](https://github.com/linkiez/DXF-Renewed/issues/54)
* Merge pull request #55 from linkiez/dependabot/npm_and_yarn/development-dependencies-d20da12dcc ([5d14812](https://github.com/linkiez/DXF-Renewed/commit/5d14812)), closes [#55](https://github.com/linkiez/DXF-Renewed/issues/55)
* Merge pull request #88 from linkiez/feature/nesting-module ([35f7dd0](https://github.com/linkiez/DXF-Renewed/commit/35f7dd0)), closes [#88](https://github.com/linkiez/DXF-Renewed/issues/88)
* chore(actions): bump actions/cache from 4 to 6 (#69) ([32146cb](https://github.com/linkiez/DXF-Renewed/commit/32146cb)), closes [#69](https://github.com/linkiez/DXF-Renewed/issues/69)
* chore(actions): bump actions/checkout from 4 to 7 ([18ffee2](https://github.com/linkiez/DXF-Renewed/commit/18ffee2))
* chore(actions): bump actions/setup-node from 4 to 7 ([75cecab](https://github.com/linkiez/DXF-Renewed/commit/75cecab))
* merge: resolve main conflicts in nesting roadmap ([83b447b](https://github.com/linkiez/DXF-Renewed/commit/83b447b))
* style(test): normalize browser test formatting ([1c5a226](https://github.com/linkiez/DXF-Renewed/commit/1c5a226))
* docs: add complete nesting roadmap with architecture and phased plan ([7687494](https://github.com/linkiez/DXF-Renewed/commit/7687494))
* docs: update svg rendering roadmap and usage ([b2e715a](https://github.com/linkiez/DXF-Renewed/commit/b2e715a))
* test(browser): cover svg rendering regressions ([a5f8ffe](https://github.com/linkiez/DXF-Renewed/commit/a5f8ffe))
* test(nesting): comprehensive test suite (109 tests, 0 failures) ([a722a9d](https://github.com/linkiez/DXF-Renewed/commit/a722a9d))
* feat: add CLI for DXF nesting ([1a1aa06](https://github.com/linkiez/DXF-Renewed/commit/1a1aa06))
* feat: add multi-bin support to nesting pipeline ([7b6e6fa](https://github.com/linkiez/DXF-Renewed/commit/7b6e6fa))
* feat: implement nesting pipeline with SVGnest algorithm ([7102840](https://github.com/linkiez/DXF-Renewed/commit/7102840))
* feat(nesting): Phase 0 - foundation types, config, and polygon utils ([60f5f9b](https://github.com/linkiez/DXF-Renewed/commit/60f5f9b))
* feat(nesting): Phase 1 - shape extraction from DXF entities ([23987a3](https://github.com/linkiez/DXF-Renewed/commit/23987a3))
* feat(nesting): Phase 2 - geometry analysis ([b26398f](https://github.com/linkiez/DXF-Renewed/commit/b26398f))
* feat(nesting): Phase 3 - bin packing algorithms ([1a2934b](https://github.com/linkiez/DXF-Renewed/commit/1a2934b))
* feat(nesting): Phase 4 - collision detection and validation ([95fbc2b](https://github.com/linkiez/DXF-Renewed/commit/95fbc2b))
* feat(nesting): Phase 5 - pipeline, output, and public API ([5eebccc](https://github.com/linkiez/DXF-Renewed/commit/5eebccc))
* feat(svg): add fill and stroke scaling controls ([3ed7be3](https://github.com/linkiez/DXF-Renewed/commit/3ed7be3))
* refactor: export nesting module from main entry point ([78f54dc](https://github.com/linkiez/DXF-Renewed/commit/78f54dc))
...
* fix(types): add export all types to index ([8f49d3b](https://github.com/linkiez/DXF-Renewed/commit/8f49d3b))
* fix(types): fix missing index ([4ef61f6](https://github.com/linkiez/DXF-Renewed/commit/4ef61f6))
