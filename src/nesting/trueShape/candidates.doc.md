# trueShape/candidates

## Visão geral
Módulo `candidates.ts` da feature 002-true-shape-nesting.

## Responsabilidades
- Âncoras bottom-left-fill: borda da chapa, borda das peças já colocadas e canto interno de cada furo.

## Entradas / Saídas
- Entradas: parâmetros tipados das funções exportadas em `candidates.ts`.
