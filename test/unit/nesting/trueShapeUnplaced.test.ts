...
describe('trueShape/unplaced', () => {
  it('reports a part larger than every stock item without throwing', () => {
    let response: ReturnType<typeof nestTrueShape> | undefined
    expect(() => {
      response = nestTrueShape({
        stock,
  ...
  it('reports only the unplaced remainder when a part partially fits', () => {
